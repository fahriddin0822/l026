...
import { FaRegHeart, FaStar, FaTrashAlt } from "react-icons/fa";
import { useNavigate } from "react-router-dom";

const HotSells = ({ data, isAdmin }) => {
  ...
  return (
    <div className="container py-12 w-full">
      <p className="mb-12 text-[40px] font-medium text-center">Best Seller</p>
      <div id="hot__selling_products" className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
        {productItems}
      </div>
    </div>
  );
